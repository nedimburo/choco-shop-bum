...
function loadTorte(){
  ...
  for (let i=0; i<torte.length; i++){
    items+=`<div class="ponuda-list-item" onclick="orderItem(${1}, ${i})">
              <div class="ponuda-list-img"><img class="ponuda-list-picture" src="slike/torte/torta${i}.jpg" alt="Torta ${i}"></div>
...
function loadKolace(){
  ...
  for (let i=0; i<kolaci.length; i++){
    items+=`<div class="ponuda-list-item" onclick="orderItem(${2}, ${i})">
              <div class="ponuda-list-img"><img class="ponuda-list-picture" src="slike/kolaci/kolaci${i}.jpg" alt="Kolac ${i}"></div>
  ...
  for (let i=0; i<praline.length; i++){
    if (praline[i].cijena=="Na upit"){
      items+=`<div class="ponuda-list-item" onclick="orderItem(${3}, ${i})">
              <div class="ponuda-list-img"><img class="ponuda-list-picture" src="slike/praline/praline${i}.jpg" alt="Praline ${i}"></div>
  ...
  for (let i=0; i<specijalnaPonuda.length; i++){
    if (specijalnaPonuda[i].cijena=="Na upit"){
      items+=`<div class="ponuda-list-item" onclick="orderItem(${4}, ${i})">
              <div class="ponuda-list-img"><img class="ponuda-list-picture" src="slike/specijalna_ponuda/specijalna${i}.jpg" alt="Specijalna ${i}"></div>
...
function orderItem(noCategory, indeks){
  ...
  if(noCategory==1){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="slike/torte/torta${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==2){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="slike/kolaci/kolaci${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==3){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="slike/praline/praline${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==4){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="slike/specijalna_ponuda/specijalna${indeks}.jpg" alt="Item"></div>
